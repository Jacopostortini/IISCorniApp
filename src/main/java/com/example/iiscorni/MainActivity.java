...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public static int NOTIFICATION_CHECKING_INTERVAL = 5*1000;
    public static int NOTIFICATION_FAM_ID = 1;
    public static int NOTIFICATION_DOC_ID = 2;
    public static int NOTIFICATION_ATA_ID = 3;
    ...
    public void startServices(){
        //TODO: fare funzionare il metodo
        SharedPreferences sharedPreferences = getPreferences(MODE_PRIVATE);

        if(sharedPreferences.getBoolean(getString(R.string.circ_fam_pref), false)){
            startService(new Intent(this, NotificheFamiglieService.class));
        }

        if(sharedPreferences.getBoolean(getString(R.string.circ_doc_pref), false)){
            startService(new Intent(this, NotificheDocentiService.class));
        }

        if(sharedPreferences.getBoolean(getString(R.string.circ_ata_pref), false)){
            startService(new Intent(this, NotificheAtaService.class));
        }
    }
