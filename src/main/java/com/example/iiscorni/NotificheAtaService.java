...
public class NotificheAtaService extends Service {

    private boolean isServiceRunning = false;
    private String circolareSalvata = "";
    //starts from 100 to reserve previous ids to different type of notification
    private int notificationId = 100;

    public NotificheAtaService() {
    }
    ...
    public void onCreate() {
        super.onCreate();
        startForeground(MainActivity.NOTIFICATION_ATA_ID, createForegroundNotification());
    }
    ...
    public void searchForChanges(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, MainActivity.URL_CIRC_ATA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if(!ultimaCircolare.equals(circolareSalvata) && !circolareSalvata.equals("")){
                            ...
                            intent.putExtra("url", MainActivity.URL_CIRC_ATA);

                            createClickableNotification(getString(R.string.notification_channel_id),
                                    R.mipmap.ic_launcher,
                                    getString(R.string.notification_title),
                                    getString(R.string.ata_notification_description),
    ...
    public Notification createForegroundNotification(){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getString(R.string.notification_channel_id))
                ...
                .setContentTitle(getString(R.string.ata_service_running_notification_title))
                .setContentText(getString(R.string.ata_service_running_notification_description))
