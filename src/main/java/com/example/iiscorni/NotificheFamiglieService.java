...
public class NotificheFamiglieService extends Service {

    private boolean isServiceRunning = false;
    private String circolareSalvata = "";
    //starts from 4 to reserve previous ids to other type of notification
    private int notificationId = 4;
    //private long dataPartenza = 0;

    public NotificheFamiglieService() {
    }
    ...
    public void onCreate() {
        super.onCreate();
        startForeground(MainActivity.NOTIFICATION_FAM_ID, createForegroundNotification());
    }
    ...
    public void searchForChanges(){
        ...
        dataPartenza = dataPartenza==0 ? timeInSeconds : dataPartenza;

        Intent intent = new Intent(getApplicationContext(), MainActivity.class);
        intent.putExtra("url", MainActivity.URL_CIRC_FAM);
        createClickableNotification(getString(R.string.notification_channel_id),
                R.mipmap.ic_launcher,
                getString(R.string.fam_service_running_notification_title),
                getString(R.string.fam_service_running_notification_description)+" ("+(timeInSeconds-dataPartenza)+" secondi)",
                NotificationCompat.PRIORITY_DEFAULT,
                MainActivity.NOTIFICATION_FAM_ID,
                intent);*/
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext());

        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://notifiche-site.herokuapp.com",//MainActivity.URL_CIRC_FAM,
                    ...
                    public void onResponse(String response) {
                        ...
                        if(!ultimaCircolare.equals(circolareSalvata) && !circolareSalvata.equals("")){
                            ...
                            createClickableNotification(getString(R.string.notification_channel_id),
                                    ...
                                    getString(R.string.fam_notification_description),
                                    NotificationCompat.PRIORITY_DEFAULT,
                                    notificationId,
                                    intent);
                            notificationId++;
    ...
    public Notification createForegroundNotification(){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext(), getString(R.string.notification_channel_id))
                ...
                .setContentTitle(getString(R.string.fam_service_running_notification_title))
                .setContentText(getString(R.string.fam_service_running_notification_description))
